...
public class ObservableList<T>
{
    ...
    public void MoveItem(int fromIndex, int toIndex)
    {
        ...
        // ≈сли перемещаем вверх по списку, нужно учесть сдвиг
    ...
    public void AssignFrom(List<T> other)
    {
        ...
        //ѕроблема в том что она добовл€ет частенько в конец и желательно щ€с синхронить первые 5 эл
